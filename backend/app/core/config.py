...
CALIBRATE_ENABLED = os.getenv("CALIBRATE_ENABLED", "true").lower() in ("1","true","yes")
CV_FOLDS = int(os.getenv("CV_FOLDS", "3"))
PDP_TOP_NUM = int(os.getenv("PDP_TOP_NUM", "2"))
SEARCH_TIME_BUDGET = int(os.getenv("SEARCH_TIME_BUDGET", "0"))  # seconds; 0 disables quick search
...
STATIC_EXPOSE_ORIGINAL = os.getenv("STATIC_EXPOSE_ORIGINAL", "false").lower() in ("1","true","yes")
...
# Feature flags
REPORT_JSON_FIRST = os.getenv("REPORT_JSON_FIRST", "false").lower() in ("1","true","yes")
SAFE_AUTO_ACTIONS = os.getenv("SAFE_AUTO_ACTIONS", "false").lower() in ("1","true","yes")

REPORT_INLINE_ASSETS = os.getenv("REPORT_INLINE_ASSETS", "false").lower() in ("1","true","yes")
